	...
	if(isset($_GET['pb'])){
		if(strcmp($_GET['pb'],"nolog")==0){
			echo '<div class="alert alert-danger" role="alert">
				<strong>You must be logged to do this action</strong> (docker user to submit/delete a job, oar user to create/delete a resource)
			</div>';
		...
		}else if(strcmp($_GET['pb'],"bad_res")==0){
			echo '<div class="alert alert-danger" role="alert">
      	  			The reservation date <strong>is not valid.</strong>
      			</div>';
	 		//header("refresh:3;/webui-oardocker/job.php");
